...
# RUN set -xe && \
#     apt-get update && \
#     apt-get install -y --no-install-recommends libgmp-dev libtinfo5 libtinfo6 && \
#     rm -rf /var/lib/apt/lists/* && \
...
#       curl -fSsL "https://downloads.sourceforge.net/project/luabinaries/$VERSION/Tools%20Executables/lua-${VERSION}_Linux44_64_bin.tar.gz" -o /tmp/lua-$VERS>
...
#     done
# RUN mkdir -p /usr/local/node-12.14.0/bin && \
#     ln -sf $(which node) /usr/local/node-12.14.0/bin/node
...
# RUN set -xe && \
#     apt-get update && \
#     apt-get install -y --no-install-recommends libncurses6 libncurses-dev && \
#     rm -rf /var/lib/apt/lists/* && \
#     for VERSION in $SWIFT_VERSIONS; do \
#       curl -fSsL "https://swift.org/builds/swift-$VERSION-release/ubuntu1804/swift-$VERSION-RELEASE/swift-$VERSION-RELEASE-ubuntu18.04.tar.gz" -o /tmp/swift>
...
# RUN set -xe && \
#     curl -fSsL "https://download.visualstudio.microsoft.com/download/pr/7d4c708b-38db-48b2-8532-9fc8a3ab0e42/23229fd17482119822bd9261b3570d87/dotnet-sdk-3.1>
